...
SKILLS = [
    {
        ...
        "items": ["PostgreSQL", "Oracle", "Couchbase", "Snowflake", "MapRDB / HBase", "SQL Server", "TiDB", "Neo4j"],
    },
    {
        "group": "Orchestration, ETL/ELT & transformation",
        "items": ["Apache Airflow", "dbt", "Talend", "Apache NiFi", "Azure Data Factory", "SSIS"],
    },
    {
        "group": "Streaming & big data",
        "items": ["Apache Kafka", "Spark Streaming", "Apache Spark", "Hadoop"],
    },
    {
        "group": "Cloud & DevOps",
        "items": ["Azure (ADF, ADLS, Key Vault, Purview)", "AWS (S3, SageMaker)", "Google Cloud (Vertex AI, Document AI)", "Docker", "Kubernetes"],
    },
    {
    ...
    },
    {
        ...
        "items": ["Python (Pandas, scikit-learn)", "XGBoost / Random Forest", "TensorFlow", "Power BI", "Tableau", "Grafana"],
    },
]

CERTIFICATIONS = [
    ("Data Engineer Streaming — Confluent", "2025"),
    ("Oracle Data Platform 2025 Certified Foundations Associate", "2025"),
    ("Apache Airflow 3.0 Fundamentals", "2025"),
    ("Neo4j Graph Professional Certification", "2023"),
    ("Neo4j Graph Data Science Certification", "2023"),
    ("Microsoft Certified: Azure Data Engineer Associate (DP-203)", "2023"),
    ("Oracle Cloud Infrastructure 2023 Foundations Associate (1Z0-1085-23)", "2023"),
    ("Oracle Cloud Data Management 2023 Foundations Associate (1Z0-1105-23)", "2023"),
    ("Basic Proficiency in KNIME Analytics Platform L1", "2023"),
    ("Apache Airflow 2.0 Fundamentals", "2023"),
    ...
    ("Hadoop Certification Professional", "2020"),
]
...
SPEAKER = [
    ...
    ("PHP Community × Developer Circle Jakarta", "2020"),
    ("Buka Meetup Kotlin — ML Performance in Kotlin", "2019"),
    ("Jabar Digital Service — Role of Data in Infrastructure", "2019"),
    ("Developer Circles Facebook Bandung — Intro to Data Science", "2019"),
    ("Google Cloud Platform, Data Science Indonesia & Google", "2019"),
    ("DevCember Festival — Data Wrangling", "2018"),
]